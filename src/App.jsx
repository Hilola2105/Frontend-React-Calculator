...
import Num from './Components/Numbers';
  ...
  render() {
    return (
      <div className='App calc'>
        ...
        <CalcActions className='clr' onTap={this.reset}>
          {' C '}
        </CalcActions>
        ...
        <CalcActions className='div' val='/' onTap={this.op}>
          {' '}
          &divide;{' '}
        </CalcActions>
        <CalcActions className='mul' val='*' onTap={this.op}>
          {` \xD7 `}
        </CalcActions>
        <CalcActions className='min' val='-' onTap={this.op}>
          {' - '}
        </CalcActions>
        <CalcActions className='add' val='+' onTap={this.op}>
          {' + '}
        </CalcActions>
        <CalcActions className='eql' onTap={this.eql}>
          {' = '}
        </CalcActions>
      </div>
    );
